...
from misc.draw_info import Drawer_DenseMap
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="/data1/YanZiheng/hrcrowd/configs/hrnet/sta_2025/rank_hrnet48_beta_256_gamma_20_labmda_01_R8.json")
