...
def optimizer_builder(args,model_without_ddp):
    ...
    if args.type.lower()=="sgd":
        ...
        return torch.optim.AdamW(params, args.lr, weight_decay=args.weight_decay,amsgrad=True)
    elif args.type.lower()=="radam":
        return torch.optim.RAdam(params, args.lr, weight_decay=args.weight_decay)
    elif args.type.lower()=="lion":
        return Lion(params, args.lr, weight_decay=args.weight_decay)
