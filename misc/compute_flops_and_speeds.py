...
def matmul_flop_jit(inputs: typing.List[object],
    ...
    flop = batch * input_shapes[0][-2] * input_shapes[0][-1] * input_shapes[1][
        -1]
...
_SUPPORTED_OPS: typing.Dict[str, typing.Callable] = {
    ...
    bmm_flop_jit,
    "aten::add":
    partial(basic_binary_op_flop_jit, name='aten::add'),
    "aten::add_":
    partial(basic_binary_op_flop_jit, name='aten::add_'),
    "aten::mul":
    partial(basic_binary_op_flop_jit, name='aten::mul'),
    "aten::sub":
    partial(basic_binary_op_flop_jit, name='aten::sub'),
    "aten::div":
    partial(basic_binary_op_flop_jit, name='aten::div'),
    "aten::floor_divide":
    partial(basic_binary_op_flop_jit, name='aten::floor_divide'),
    "aten::relu":
    partial(basic_binary_op_flop_jit, name='aten::relu'),
    "aten::relu_":
    partial(basic_binary_op_flop_jit, name='aten::relu_'),
    "aten::rsqrt":
    rsqrt_flop_jit,
    "aten::softmax":
    softmax_flop_jit,
...
def flop_count(
    ...
    customized_ops: typing.Union[typing.Dict[str, typing.Callable],
                                 None] = None,
