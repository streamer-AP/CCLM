...
draw=True
img_dir="data/NWPU_origin/images"
out_dir="local_eval/nwpu_val_vis"
if args.eval_dataset == 'ShanghaiA':
    ...
    gt_file = 'local_eval/gt_files/nwpu_val.txt'
    # pred_file = 'local_eval/nwpu_pred_fidt.txt'
    pred_file = 'local_eval/nwpu_val_pred.txt'
